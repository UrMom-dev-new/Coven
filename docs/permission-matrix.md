...
| Hermes live adapter | Future owner of real task dispatch and runtime event ingestion | Invented endpoints, silent synthetic success, profile self-privilege expansion |
